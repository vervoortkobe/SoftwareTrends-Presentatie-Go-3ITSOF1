            ...
            if (data.posts && data.posts.length > 0) {
                postList.innerHTML = data.posts.map(post => `
                    <div class="list-group-item">
                        ...
                        <small class="text-muted">Gepost door: ${post.username}</small>
                        ${post.isOwner ? `
                            <div class="mt-2">
                                <button class="btn btn-sm btn-outline-primary me-2" onclick="openEditModal(${post.id}, '${post.title.replace(/'/g, "\\'")}', '${post.content.replace(/'/g, "\\'")}')">
                                    Edit
                                </button>
                ...
                postList.innerHTML = '<div class="list-group-item">Geen Posts beschikbaar.</div>';
            }
        } else {
